<?php  
 ...
 require_once "./modelo/loginModelo2.php";



class loginControlador2 extends loginModelo2{
  ...
  public function login(){
    ...
    $ilogin=loginModelo2::iniciar_sesion($datosUser);
        ...
        if(password_verify ($pass,$hash ) ){
            ...
            if($_SESSION["logueado"] == TRUE){
                if($cargo=="Administrador"){
                    ...
                    $alerta=[
                        "Titulo"=>"Correcto",
                        "Texto"=>"http://localhost/SistemaFinanciero/inicio/?tipo=1",
                        "Tipo"=>"success"
                    ];
                    ...
                    $alerta=[
                        "Titulo"=>"Correcto",
                        "Texto"=>"http://localhost/SistemaFinanciero/inicio/?tipo=0",
                        "Tipo"=>"success"
                    ];
                }
...
$insLogin=new loginControlador2();
